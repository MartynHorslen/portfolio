    ...
    <header>
        ...
        <nav>
            ...
            <ul>
                ...
                <li><a href="index.php#portfolio" onclick="slideUp()">My Portfolio</a></li>
                <li><a href="code.php">Code Examples</a></li>
                <li><a href="scion.php">SCS Scheme</a></li>
                <li><a href="index.php#contact" onclick="slideUp()">Contact Me</a></li>
            </ul>
        </nav>
        <div id="social">
